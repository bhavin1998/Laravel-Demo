            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-4 text-right">
                        <a href="{{route('userregistration')}}" class="btn btn-sm btn-primary" id="btnadduser">Add user</a>
                    </div>

                    <div>
                        <select class="form-control userroles" id="userrole">
                        <option value="" class="roleoption">Select Role</option>
                            @foreach ($user as $users)
                                <option value="{{$users->id}}" name="{{$users->id}}" class="roleoption">{{$users->name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                <a class="dropdown-item" href="{{route('edituser',$userrole->id)}}">View</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
